...
from model.KPConv.kernels.kernel_points import load_kernels
from model.KPConv.operations import *
...
# Module Content:
#   - Base Modules:
#       1. KPConv: Base module for KPConv
#       2. BatchNormBlock: Base module containing a BN / an IN only
#   - Complex Modules:
#       3. UnaryBlock: Module containing a 'mlp-bn-activation' arch
#       4. LastUnaryBlock: Module containing a single mlp
#       5. SimpleBlock: Module containing a 'kpconv-bn-activation' arch
#       6. ResnetBottleneckBlock: Module containing dual paths:
#                                 1. MaxPooling / ShortCut_UnaryBlock
#                                 2. UnaryBlock1 + KPConv + UnaryBlock2
#                                 3. Activation(1 + 2)
#   - Non-parameter Modules:
#       7. GlobalAverageBlock:
#       8. NearestUpsampleBlock:
#       9. MaxPoolBlock:
################################################################################
